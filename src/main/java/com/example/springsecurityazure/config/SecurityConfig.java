...
//                            response.setHeader("Access-Control-Allow-Origin", "http://127.0.0.1:5500");
                            response.setHeader("Access-Control-Allow-Origin", "https://polite-cliff-027946e03.3.azurestaticapps.net");
...
//                            corsConfiguration.setAllowedOrigins(List.of("http://127.0.0.1:5500"));
                            corsConfiguration.setAllowedOrigins(List.of("https://polite-cliff-027946e03.3.azurestaticapps.net"));
